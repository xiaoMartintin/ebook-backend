...
public interface OrderRepository extends JpaRepository<Order, Integer> {
    ...
    @Query("SELECT o FROM Order o WHERE "
            ...
            + "AND (:keyword IS NULL OR :keyword = '' OR LOWER(o.receiver) LIKE LOWER(CONCAT('%', :keyword, '%')) "
    ...
    Page<Order> findOrders(@Param("userId") Integer userId, @Param("keyword") String keyword,
                           @Param("startInstant") Instant startInstant, @Param("endInstant") Instant endInstant, Pageable pageable);
    ...
    @Query("SELECT o FROM Order o WHERE "
            ...
            + "AND (:startInstant IS NULL OR o.time >= :startInstant) "
            + "AND (:endInstant IS NULL OR o.time <= :endInstant)")
    Page<Order> findAllOrders(@Param("keyword") String keyword,
